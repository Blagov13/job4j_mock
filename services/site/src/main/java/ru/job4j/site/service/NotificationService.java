...
public class NotificationService {
    ...
    public NotificationService(KafkaTemplate<String, Object> kafkaTemplate, @Value("${service.notification}") String notificationServiceUrl) {
    ...
    public void addSubscribeTopic(int userId, int topicId) throws JsonProcessingException {
    ...
    public void deleteSubscribeTopic(int userId, int topicId) throws JsonProcessingException {
